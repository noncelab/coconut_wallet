  ...
  void _showTargetSettingBottomSheet(
    ...
    final btcString =
        viewModel.targetSats != null
            ? _satsToBtcInputString(viewModel.targetSats!)
            : '';
          ...
          (context) => _TargetQuantitySettingBottomSheet(
            ...
            onComplete: (text) {
              ...
              if (btc > 21_000_000) {
                CoconutToast.showWarningToast(
                  context: context,
                  text: t.wallet_info_screen.target_set_max_exceeded,
                );
                return false;
              }
              if (btc == 21_000_000) {
...
class _StatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color:
            transparentBackground ? Colors.transparent : CoconutColors.gray800,
...
class _TargetQuantitySettingBottomSheet extends StatefulWidget {
  ...
  const _TargetQuantitySettingBottomSheet({
    required this.initialBtcString,
    required this.onComplete,
  });

  @override
  State<_TargetQuantitySettingBottomSheet> createState() =>
      _TargetQuantitySettingBottomSheetState();
}

class _TargetQuantitySettingBottomSheetState
    extends State<_TargetQuantitySettingBottomSheet> {
