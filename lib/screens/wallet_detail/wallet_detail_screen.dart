...
class _WalletDetailScreenState extends State<WalletDetailScreen> {
                ...
                children: [
                  Scaffold(
                    ...
                    appBar: CoconutAppBar.build(
                        ...
                        faucetIconKey: _faucetIconKey, // CDS에서 제거 필요
                        ...
                        actionButtonList: [
                          IconButton(
                              onPressed: () {
                                _onFaucetIconPressed(
                                    viewModel, state, balance, isNetworkOn);
                              },
                          ...
                          IconButton(
                              onPressed: () {
                                Navigator.pushNamed(context, '/utxo-list');
                              },
                              icon: SvgPicture.asset(
  ...
  void _toggleListType(
      WalletDetailTabType type, List<UtxoState> utxoList) async {
