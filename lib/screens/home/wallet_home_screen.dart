                      ...
                      children: [
                        GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final onPressed = switch (scanType) {
                              WalletImportSource.bitbox02 => _goToBitBox02Screen,
                              WalletImportSource.trezor => _goToTrezorScreen,
                              _ => () => _goToScannerScreen(scanType),
                            };
