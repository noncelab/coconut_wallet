          ...
          child: CupertinoTheme(
            data: CupertinoThemeData(
              ...
              textTheme: CupertinoTextThemeData(
                dateTimePickerTextStyle: CoconutTypography.heading3_21.setColor(
                  CoconutColors.white,
                ),
              ),
            ),
      ...
      body: Container(
        ...
        child: Stack(
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  AnimatedSwitcher(
                    ...
                    child: _selectedPeriodIndices[3]
                        ? Row(
                            children: [
                              Expanded(
                                child: CoconutButton(
                                  height: 50,
                                  onPressed: () => _showDateSpinner(
                                      isStart: true,
                  ...
                  CoconutSegmentedControl(
                    ...
                    isSelected: transactionTypes
                        .map((type) => type == _selectedAnalysisTransactionType)
                        .toList(),
                    onPressed: (index) {
                      setState(() {
            ...
            FixedBottomButton(
              onButtonClicked: () {
                final selectedIndex = _selectedPeriodIndices.indexWhere((e) => e) == -1
                    ? 0
                    : _selectedPeriodIndices.indexWhere((e) => e);
                if (selectedIndex == 3) {
                  context
                      .read<PreferenceProvider>()
                      .setAnalysisPeriodRange(_startDate!, _endDate ?? DateTime.now());
                }
              ...
              isActive: (() {
                final selectedIndex = _selectedPeriodIndices.indexWhere((e) => e) == -1
                    ? 0
                    : _selectedPeriodIndices.indexWhere((e) => e);
                final int initialIndex = widget.initialPeriodPreset == 0
                    ? 3
                    : presets.indexOf(widget.initialPeriodPreset);
                bool changedDays;
                ...
                if (selectedIndex == 3) {
                  ...
                  DateTime? dOnly(DateTime? d) =>
                      d == null ? null : DateTime(d.year, d.month, d.day);

                  changedDays = dOnly(_startDate) != dOnly(initialStart) ||
                      dOnly(_endDate) != dOnly(initialEnd);
                } else {
