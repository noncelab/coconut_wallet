      ...
      child: Column(
        children: [
          _buildEditModeHeaderLine([
            ...
            if (_viewModel.isKorean) WidgetSpan(alignment: PlaceholderAlignment.top, child: starIcon),
          ...
          _buildEditModeHeaderLine([
            ...
            if (_viewModel.isKorean) WidgetSpan(alignment: PlaceholderAlignment.top, child: hamburgerIcon),
