...
class _WalletListScreenState extends State<WalletListScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Logger.log('hasLauchBefore ? ${_subModel.hasLaunchedBefore}');
              ...
              slivers: <Widget>[
                  ...
                  SliverToBoxAdapter(
                    child: Selector<AppStateModel, WalletInitState>(
                      ...
                      builder: (context, state, child) {
                        // Logger.log(
                        //     '>>>>>>> WalletListScreen Selector walletInitState -> $state'); // TODO: 왜이렇게 많이 호출되는지 모르겠다.
                ...
                SliverSafeArea(
                  ...
                  sliver: Selector<AppStateModel, bool>(
                    selector: (_, selectorModel) => selectorModel.fastLoadDone,
