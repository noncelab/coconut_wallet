                          ...
                          Row(
                            children: [
                              ...
                              if (serverConnectionStatus == NodeConnectionStatus.connecting) ...[
                                ...
                                const ContentLoadingIndicator(padding: EdgeInsets.zero, radius: 6),
                              ],
            ...
            builder: (context, nodeConnectionStatus, child) {
              ...
              return IgnorePointer(
                ...
                child: CoconutSwitch(
                  ...
                  activeThumbColor:
                      isNodeConnecting
                          ? context.coconutColors.switchThumbDisabled
                          : context.coconutColors.switchActiveThumb,
                  inactiveThumbColor:
                      isNodeConnecting
                          ? context.coconutColors.switchThumbDisabled
                          : context.coconutColors.switchInactiveThumb,
                ),
              );
            },
          ),
  ...
  Widget _buildAlertIcon(NodeConnectionStatus status) {
    switch (status) {
      ...
      case NodeConnectionStatus.connecting:
        {
          return const ContentLoadingIndicator(padding: EdgeInsets.zero, radius: 10);
        }
