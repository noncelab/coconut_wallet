                    ...
                    children: [
                                ...
                                AdaptiveQrImage(
                                  qrData:
                                      viewModel.isBbqrType && viewModel.hasBbqrParts
                                          ...
                                          : null,
                                  qrDensity: viewModel.isBbqrType ? null : viewModel.qrScanDensity,
                                  qrViewDataHandler:
                                      viewModel.isBbqrType
                                          ? null
                                          : BcUrQrViewHandler(_psbtBase64, viewModel.qrScanDensity, {
                                            'urType': 'crypto-psbt',
                                          }),
                                ),
                      ...
                      FixedBottomButton(
                        ...
                        subWidget: CoconutUnderlinedButton(
                          text:
                              viewModel.isBbqrType
                                  ? t.unsigned_tx_qr_screen.view_ur
                                  : t.unsigned_tx_qr_screen.view_bbqr,
                          onTap: () {
