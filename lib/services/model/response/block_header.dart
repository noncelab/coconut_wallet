...
class BlockHeader {
  ...
  factory BlockHeader.parse(int height, String header) {
    ...
    Uint8List prevBlockHash = Uint8List.fromList(bytes.sublist(4, 36).reversed.toList());
    Uint8List merkleRoot = Uint8List.fromList(bytes.sublist(36, 68).reversed.toList());
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'header': header,
      'version': version,
      'prevBlockHash': prevBlockHash != null ? base64Encode(prevBlockHash!) : null,
