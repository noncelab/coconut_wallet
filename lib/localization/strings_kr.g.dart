...
class TranslationsTooltipKr {
	...
	String get address_receiving => '비트코인을 받을 때 사용하는 주소예요. 영어로 Receiving 또는 External이라 해요.';
	String get address_change => '다른 사람에게 비트코인을 보내고 남은 비트코인을 거슬러 받는 주소예요. 영어로 Change라 해요.';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'tooltip.address_receiving': return '비트코인을 받을 때 사용하는 주소예요. 영어로 Receiving 또는 External이라 해요.';
			case 'tooltip.address_change': return '다른 사람에게 비트코인을 보내고 남은 비트코인을 거슬러 받는 주소예요. 영어로 Change라 해요.';
