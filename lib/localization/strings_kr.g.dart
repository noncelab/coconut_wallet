...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	String get faucet_already_request => '해당 주소로 이미 요청했습니다. 입금까지 최대 5분이 걸릴 수 있습니다.';
	String get faucet_failed => '요청에 실패했습니다. 잠시 후 다시 시도해 주세요.';
	String get bio_auth_required => '생체 인증을 진행해 주세요';
	late final TranslationsTransactionEnumsKr transaction_enums = TranslationsTransactionEnumsKr.internal(_root);
	late final TranslationsUtxoOrderEnumsKr utxo_order_enums = TranslationsUtxoOrderEnumsKr.internal(_root);
	late final TranslationsPinCheckScreenKr pin_check_screen = TranslationsPinCheckScreenKr.internal(_root);
	late final TranslationsWalletAddScannerScreenKr wallet_add_scanner_screen = TranslationsWalletAddScannerScreenKr.internal(_root);
	late final TranslationsNegativeFeedbackScreenKr negative_feedback_screen = TranslationsNegativeFeedbackScreenKr.internal(_root);
	late final TranslationsPositiveFeedbackScreenKr positive_feedback_screen = TranslationsPositiveFeedbackScreenKr.internal(_root);
	late final TranslationsBroadcastingCompleteScreenKr broadcasting_complete_screen = TranslationsBroadcastingCompleteScreenKr.internal(_root);
	late final TranslationsBroadcastingScreenKr broadcasting_screen = TranslationsBroadcastingScreenKr.internal(_root);
	late final TranslationsSendAddressScreenKr send_address_screen = TranslationsSendAddressScreenKr.internal(_root);
	late final TranslationsSendConfirmScreenKr send_confirm_screen = TranslationsSendConfirmScreenKr.internal(_root);
	late final TranslationsSignedPsbtScannerScreenKr signed_psbt_scanner_screen = TranslationsSignedPsbtScannerScreenKr.internal(_root);
	late final TranslationsAppInfoScreenKr app_info_screen = TranslationsAppInfoScreenKr.internal(_root);
	late final TranslationsBip39ListScreenKr bip39_list_screen = TranslationsBip39ListScreenKr.internal(_root);
	...
	late final TranslationsWalletInfoScreenKr wallet_info_screen = TranslationsWalletInfoScreenKr.internal(_root);
	late final TranslationsTransactionFeeBumpingScreenKr transaction_fee_bumping_screen = TranslationsTransactionFeeBumpingScreenKr.internal(_root);
	late final TranslationsWalletListAddGuideCardKr wallet_list_add_guide_card = TranslationsWalletListAddGuideCardKr.internal(_root);
	late final TranslationsWalletListTermsShortcutCardKr wallet_list_terms_shortcut_card = TranslationsWalletListTermsShortcutCardKr.internal(_root);
	late final TranslationsFaucetRequestBottomSheetKr faucet_request_bottom_sheet = TranslationsFaucetRequestBottomSheetKr.internal(_root);
	late final TranslationsLicenseBottomSheetKr license_bottom_sheet = TranslationsLicenseBottomSheetKr.internal(_root);
	late final TranslationsOnboardingBottomSheetKr onboarding_bottom_sheet = TranslationsOnboardingBottomSheetKr.internal(_root);
	late final TranslationsSecuritySelfCheckBottomSheetKr security_self_check_bottom_sheet = TranslationsSecuritySelfCheckBottomSheetKr.internal(_root);
	late final TranslationsTagBottomSheetKr tag_bottom_sheet = TranslationsTagBottomSheetKr.internal(_root);
	late final TranslationsTermsBottomSheetKr terms_bottom_sheet = TranslationsTermsBottomSheetKr.internal(_root);
	late final TranslationsUserExperienceSurveyBottomSheetKr user_experience_survey_bottom_sheet = TranslationsUserExperienceSurveyBottomSheetKr.internal(_root);
...
class TranslationsAppInfoScreenKr {
	...
	String version_and_date({required Object version, required Object releasedAt}) => 'CoconutWallet ver. ${version} (released at ${releasedAt})';
...
class TranslationsTransactionFeeBumpingScreenKr {
	...
	String recommend_fee_info_cpfp({required Object newTxSize, required Object recommendedFeeRate, required Object originalTxSize, required Object totalRequiredFee, required Object originalFee, required Object newTxFee, required Object inequalitySign, required Object newTxFeeRate}) => '새로운 거래로 부족한 수수료를 보충해야 해요.\n • 새 거래의 크기 = ${newTxSize} vb, 추천 수수료율 = ${recommendedFeeRate} sat/vb\n • 필요한 총 수수료 = (${originalTxSize} + ${newTxSize}) × ${recommendedFeeRate} = ${totalRequiredFee} sat\n • 새 거래의 수수료 = ${totalRequiredFee} - ${originalFee} = ${newTxFee} sat\n • 새 거래의 수수료율 = ${newTxFee} ÷ ${newTxSize} ${inequalitySign} ${newTxFeeRate} sat/vb';
	...
	String get recommended_fee_less_than_pending_tx_fee => '기존 수수료보다 큰 수수료를 지정해 주세요';
	String get recommended_fee_less_than_network_fee => '추천 수수료 이상으로 지정해 주세요';
	late final TranslationsTransactionFeeBumpingScreenDialogKr dialog = TranslationsTransactionFeeBumpingScreenDialogKr.internal(_root);
	late final TranslationsTransactionFeeBumpingScreenToastKr toast = TranslationsTransactionFeeBumpingScreenToastKr.internal(_root);
}
...
class TranslationsFaucetRequestBottomSheetKr {
	...
	String my_address({required Object name, required Object index}) => '내 지갑(${name}) 주소 - ${index}';
...
class TranslationsLicenseBottomSheetKr {
	...
	String get copyright_text1 => '코코넛 월렛은 MIT 라이선스를 따르며 저작권은 대한민국의 논스랩 주식회사에 있습니다. MIT 라이선스 전문은 ';
	String get copyright_text2 => '에서 확인해 주세요.\n\n이 애플리케이션에 포함된 타사 소프트웨어에 대한 저작권을 다음과 같이 명시합니다. 이에 대해 궁금한 사항이 있으시면 ';
...
class TranslationsErrorsKr {
	...
	late final TranslationsErrorsFeeSelectionErrorKr fee_selection_error = TranslationsErrorsFeeSelectionErrorKr.internal(_root);
	late final TranslationsErrorsAddressErrorKr address_error = TranslationsErrorsAddressErrorKr.internal(_root);
	late final TranslationsErrorsPinCheckErrorKr pin_check_error = TranslationsErrorsPinCheckErrorKr.internal(_root);
	late final TranslationsErrorsPinSettingErrorKr pin_setting_error = TranslationsErrorsPinSettingErrorKr.internal(_root);
...
class TranslationsTooltipKr {
	...
	String amount_to_be_sent({required Object bitcoin}) => '받기 완료된 비트코인만 전송 가능해요.\n받는 중인 금액: ${bitcoin} BTC';
	String get scan_signed_psbt => '볼트 앱에서 생성된 서명 트랜잭션이 보이시나요? 이제, QR 코드를 스캔해 주세요.';
	late final TranslationsTooltipUnsignedTxQrKr unsigned_tx_qr = TranslationsTooltipUnsignedTxQrKr.internal(_root);
	String get address_receiving => '비트코인을 받을 때 사용하는 주소예요. 영어로 Receiving 또는 External이라고 해요.';
	String get address_change => '다른 사람에게 비트코인을 보내고 남은 비트코인을 거슬러 받는 주소예요. 영어로 Change라고 해요.';
	String get utxo => 'UTXO란 Unspent Tx Output을 줄인 말로 아직 쓰이지 않은 잔액이란 뜻이에요. 비트코인에는 잔액 개념이 없어요. 지갑에 표시되는 잔액은 UTXO의 총합이라는 것을 알아두세요.';
	String get faucet => '테스트용 비트코인으로 마음껏 테스트 해보세요';
	String multisig_wallet({required Object total, required Object count}) => '${total}개의 키 중 ${count}개로 서명해야 하는\n다중 서명 지갑이에요.';
	String get mfp => '지갑의 고유 값이에요.\n마스터 핑거프린트(MFP)라고도 해요.';
	String get rbf => '수수료를 올려, 기존 거래를 새로운 거래로 대체하는 기능이에요. (RBF, Replace-By-Fee)';
	String get cpfp => '새로운 거래(Child)에 높은 수수료를 지정해 기존 거래(Parent)가 빨리 처리되도록 우선순위를 높이는 기능이에요. (CPFP, Child-Pays-For-Parent)';
}
...
class TranslationsToastKr {
	...
	String min_fee({required Object minimum}) => '현재 최소 수수료는 ${minimum} sats/vb 입니다.';
...
class TranslationsAlertKr {
	...
	// Translations
	late final TranslationsAlertErrorTxKr error_tx = TranslationsAlertErrorTxKr.internal(_root);
	late final TranslationsAlertErrorSendKr error_send = TranslationsAlertErrorSendKr.internal(_root);
	late final TranslationsAlertSignedPsbtKr signed_psbt = TranslationsAlertSignedPsbtKr.internal(_root);
	String scan_failed({required Object error}) => '\'[스캔 실패] ${error}\'';
	String scan_failed_description({required Object error}) => 'QR코드 스캔에 실패했어요. 다시 시도해 주세요.\n${error}';
	late final TranslationsAlertTutorialKr tutorial = TranslationsAlertTutorialKr.internal(_root);
	late final TranslationsAlertForgotPasswordKr forgot_password = TranslationsAlertForgotPasswordKr.internal(_root);
	late final TranslationsAlertWalletAddKr wallet_add = TranslationsAlertWalletAddKr.internal(_root);
	late final TranslationsAlertWalletDeleteKr wallet_delete = TranslationsAlertWalletDeleteKr.internal(_root);
	late final TranslationsAlertUpdateKr update = TranslationsAlertUpdateKr.internal(_root);
	String get error_occurs => '오류 발생';
	String contact_admin({required Object error}) => '관리자에게 문의하세요. ${error}';
	late final TranslationsAlertTagApplyKr tag_apply = TranslationsAlertTagApplyKr.internal(_root);
	...
	late final TranslationsAlertRecipientDeleteKr recipient_delete = TranslationsAlertRecipientDeleteKr.internal(_root);
...
class TranslationsTransactionFeeBumpingScreenDialogKr {
	...
	String get fee_alert_description => '설정하신 총 수수료가 0.01 BTC 이상이에요. 그래도 계속 진행하시겠어요?';
...
class TranslationsErrorsFeeSelectionErrorKr {
	...
	String get recommended_fee_unavailable => '추천 수수료를 조회하지 못했어요.\n\'변경\' 버튼을 눌러 수수료를 직접 입력해 주세요.';
...
class TranslationsAlertErrorSendKr {
	...
	String get insufficient_balance => '잔액이 부족해요';
	String minimum_amount({required Object bitcoin}) => '${bitcoin} BTC 부터 전송할 수 있어요';
...
class TranslationsAlertForgotPasswordKr {
	...
	String get description => '[다시 설정]을 눌러 비밀번호를 초기화할 수 있어요. 비밀번호를 바꾸면 동기화된 지갑 목록이 초기화 돼요.';
...
class TranslationsAlertWalletAddKr {
	...
	// Translations
	String get update_failed => '업데이트 실패';
	String update_failed_description({required Object name}) => '${name}에 업데이트할 정보가 없어요';
	String get duplicate_name => '이름 중복';
	String get duplicate_name_description => '같은 이름을 가진 지갑이 있습니다.\n이름을 변경한 후 동기화 해주세요.';
...
class TranslationsAlertTagDeleteKr {
	...
	String description_utxo_tag({required Object name, required Object count}) => '${name}를 정말로 삭제하시겠어요?\n${count}개 UTXO에 적용되어 있어요.';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'coconut_wallet': return 'coconut_wallet';
			case 'coconut_vault': return 'coconut_vault';
			case 'coconut_lib': return 'coconut_lib';
			...
			case 'amount': return '수량';
			case 'send_amount': return '보낼 수량';
			case 'fetch_fee_failed': return '수수료 조회 실패';
			case 'fetch_balance_failed': return '잔액 조회 불가';
			case 'status_used': return '사용됨';
			case 'status_unused': return '사용 전';
			case 'status_receiving': return '받는 중';
			case 'status_received': return '받기 완료';
			case 'status_sending': return '보내는 중';
			case 'status_sent': return '보내기 완료';
			case 'status_updating': return '업데이트 중';
			case 'no_status': return '상태 없음';
			case 'quick_receive': return '빨리 받기';
			case 'quick_send': return '빨리 보내기';
			...
			case 'view_mempool': return '멤풀 보기';
			case 'view_all_addresses': return '전체 주소 보기';
			case 'select_utxo': return 'UTXO 고르기';
			case 'select_all': return '모두 선택';
			case 'unselect_all': return '모두 해제';
			case 'delete_confirm': return '삭제하기';
			case 'sign_multisig': return '다중 서명하기';
			case 'forgot_password': return '비밀번호가 기억나지 않나요?';
			case 'tx_not_found': return '거래 내역이 없어요';
			case 'utxo_not_found': return 'UTXO가 없어요';
			case 'utxo_loading': return 'UTXO를 확인하는 중이에요';
			case 'faucet_request': return '테스트 비트코인을 요청했어요. 잠시만 기다려 주세요.';
			case 'faucet_already_request': return '해당 주소로 이미 요청했습니다. 입금까지 최대 5분이 걸릴 수 있습니다.';
			case 'faucet_failed': return '요청에 실패했습니다. 잠시 후 다시 시도해 주세요.';
			case 'bio_auth_required': return '생체 인증을 진행해 주세요';
			case 'transaction_enums.high_priority': return '빠른 전송';
			case 'transaction_enums.medium_priority': return '보통 전송';
			case 'transaction_enums.low_priority': return '느린 전송';
			case 'transaction_enums.expected_time_high_priority': return '~10분';
			case 'transaction_enums.expected_time_medium_priority': return '~30분';
			case 'transaction_enums.expected_time_low_priority': return '~1시간';
			case 'utxo_order_enums.amt_desc': return '큰 금액순';
			case 'utxo_order_enums.amt_asc': return '작은 금액순';
			case 'utxo_order_enums.time_desc': return '최신순';
			case 'utxo_order_enums.time_asc': return '오래된 순';
			case 'pin_check_screen.text': return '비밀번호를 눌러주세요';
			case 'wallet_add_scanner_screen.text': return '보기 전용 지갑 추가';
			case 'negative_feedback_screen.text1': return '죄송합니다😭';
			case 'negative_feedback_screen.text2': return '불편한 점이나 개선사항을 저희에게 알려주세요!';
			case 'negative_feedback_screen.text3': return '1:1 메시지 보내기';
			case 'negative_feedback_screen.text4': return '다음에 할게요';
			case 'positive_feedback_screen.text1': return '감사합니다🥰';
			case 'positive_feedback_screen.text2': return '그렇다면 스토어에 리뷰를 남겨주시겠어요?';
			case 'positive_feedback_screen.text3': return '물론이죠';
			case 'positive_feedback_screen.text4': return '다음에 할게요';
			case 'broadcasting_complete_screen.complete': return '전송 요청 완료';
			case 'broadcasting_screen.title': return '최종 확인';
			case 'broadcasting_screen.description': return '아래 정보로 송금할게요';
			case 'broadcasting_screen.self_sending': return '내 지갑으로 보내는 트랜잭션입니다.';
			case 'broadcasting_screen.error_popup_title': return '브로드캐스팅 실패';
			case 'send_address_screen.text1': return 'QR을 스캔하거나\n복사한 주소를 붙여넣어 주세요';
			case 'send_address_screen.text2': return '주소 QR 코드를 스캔해 주세요';
			case 'send_address_screen.add_recipient': return '받는 사람 추가하기';
			case 'send_address_screen.address_placeholder': return '보낼 주소를 입력해 주세요';
			case 'send_address_screen.amount_placeholder': return '보낼 수량을 입력해 주세요';
			case 'send_confirm_screen.title': return '입력 정보 확인';
			case 'signed_psbt_scanner_screen.title': return '서명 트랜잭션 읽기';
			...
			case 'app_info_screen.category2_opensource': return 'Coconut Wallet은 오픈소스입니다';
			case 'app_info_screen.license': return '라이선스 안내';
			case 'app_info_screen.contribution': return '오픈소스 개발 참여하기';
			case 'app_info_screen.version_and_date': return ({required Object version, required Object releasedAt}) => 'CoconutWallet ver. ${version} (released at ${releasedAt})';
			case 'app_info_screen.inquiry': return '문의 내용';
			case 'bip39_list_screen.result': return ({required Object text}) => '\'${text}\' 검색 결과';
			case 'bip39_list_screen.no_result': return '검색 결과가 없어요';
			...
			case 'settings_screen.hide_balance': return '홈 화면 잔액 숨기기';
			case 'address_list_screen.wallet_name': return ({required Object name}) => '${name}의 주소';
			...
			case 'utxo_tag_screen.add_tag': return '+ 버튼을 눌러 태그를 추가해 보세요';
			case 'wallet_info_screen.title': return ({required Object name}) => '${name} 정보';
			case 'wallet_info_screen.view_xpub': return '확장 공개키 보기';
			case 'transaction_fee_bumping_screen.rbf': return 'RBF';
			...
			case 'transaction_fee_bumping_screen.recommend_fee': return ({required Object fee}) => '최소 수수료: ${fee} sats/vb 이상';
			case 'transaction_fee_bumping_screen.recommend_fee_info_rbf': return '기존 수수료 보다 1 sat/vb 이상 커야해요.\n하지만, (기존 수수료 + 1)값이 느린 전송 수수료 보다 작다면 느린 전송 수수료를 추천해요.\n단, 새 거래의 크기가 증가하면 추천 수수료와 기존 수수료 차이가 1 sat/vb 미만으로 보일 수 있어요.';
			case 'transaction_fee_bumping_screen.recommend_fee_info_cpfp': return ({required Object newTxSize, required Object recommendedFeeRate, required Object originalTxSize, required Object totalRequiredFee, required Object originalFee, required Object newTxFee, required Object inequalitySign, required Object newTxFeeRate}) => '새로운 거래로 부족한 수수료를 보충해야 해요.\n • 새 거래의 크기 = ${newTxSize} vb, 추천 수수료율 = ${recommendedFeeRate} sat/vb\n • 필요한 총 수수료 = (${originalTxSize} + ${newTxSize}) × ${recommendedFeeRate} = ${totalRequiredFee} sat\n • 새 거래의 수수료 = ${totalRequiredFee} - ${originalFee} = ${newTxFee} sat\n • 새 거래의 수수료율 = ${newTxFee} ÷ ${newTxSize} ${inequalitySign} ${newTxFeeRate} sat/vb';
			case 'transaction_fee_bumping_screen.current_fee': return '추천 수수료';
			case 'transaction_fee_bumping_screen.estimated_fee': return ({required Object fee}) => '예상 총 수수료 약 ${fee} sats';
			...
			case 'transaction_fee_bumping_screen.recommended_fees_is_null': return '수수료를 조회하는 중이에요';
			case 'transaction_fee_bumping_screen.recommended_fee_less_than_pending_tx_fee': return '기존 수수료보다 큰 수수료를 지정해 주세요';
			case 'transaction_fee_bumping_screen.recommended_fee_less_than_network_fee': return '추천 수수료 이상으로 지정해 주세요';
			case 'transaction_fee_bumping_screen.dialog.fee_alert_title': return '알림';
			case 'transaction_fee_bumping_screen.dialog.fee_alert_description': return '설정하신 총 수수료가 0.01 BTC 이상이에요. 그래도 계속 진행하시겠어요?';
			case 'transaction_fee_bumping_screen.dialog.confirmed_alert_title': return '거래 완료';
			case 'transaction_fee_bumping_screen.dialog.confirmed_alert_description': return '처리 대기 중이던 거래가 완료되었어요.';
			case 'transaction_fee_bumping_screen.toast.insufficient_utxo': return '잔액이 부족하여 새 거래를 생성할 수 없어요';
			...
			case 'wallet_list_add_guide_card.btn_add': return '바로 추가하기';
			case 'wallet_list_terms_shortcut_card.any_terms_you_dont_know': return '모르는 용어가 있으신가요?';
			case 'wallet_list_terms_shortcut_card.top_right': return '오른쪽 위 ';
			case 'wallet_list_terms_shortcut_card.click_to_jump': return ' - 용어집 또는 여기를 눌러 바로가기';
			case 'faucet_request_bottom_sheet.title': return '테스트 비트코인 받기';
			case 'faucet_request_bottom_sheet.recipient': return '받을 주소';
			case 'faucet_request_bottom_sheet.placeholder': return '주소를 입력해 주세요.\n주소는 [받기] 버튼을 눌러서 확인할 수 있어요.';
			case 'faucet_request_bottom_sheet.my_address': return ({required Object name, required Object index}) => '내 지갑(${name}) 주소 - ${index}';
			case 'faucet_request_bottom_sheet.requesting': return '요청 중...';
			case 'faucet_request_bottom_sheet.request_amount': return ({required Object bitcoin}) => '${bitcoin} BTC 요청하기';
			case 'license_bottom_sheet.title': return '라이선스 안내';
			case 'license_bottom_sheet.coconut_wallet': return 'Coconut Wallet';
			case 'license_bottom_sheet.copyright_text1': return '코코넛 월렛은 MIT 라이선스를 따르며 저작권은 대한민국의 논스랩 주식회사에 있습니다. MIT 라이선스 전문은 ';
			case 'license_bottom_sheet.copyright_text2': return '에서 확인해 주세요.\n\n이 애플리케이션에 포함된 타사 소프트웨어에 대한 저작권을 다음과 같이 명시합니다. 이에 대해 궁금한 사항이 있으시면 ';
			case 'license_bottom_sheet.copyright_text3': return '으로 문의해 주시기 바랍니다.';
			case 'license_bottom_sheet.email_subject': return '[월렛] 라이선스 문의';
			case 'onboarding_bottom_sheet.skip': return '건너뛰기 |';
			...
			case 'tag_bottom_sheet.max_tag_count': return '태그는 최대 5개 지정할 수 있어요';
			case 'terms_bottom_sheet.ask_to_pow': return '포우에 물어보기';
			case 'terms_bottom_sheet.ask_to_telegram': return '텔레그램에 물어보기';
			case 'terms_bottom_sheet.synonym': return '같은 용어';
			case 'terms_bottom_sheet.related_terms': return '관련 용어';
			case 'user_experience_survey_bottom_sheet.text1': return '비트코인 전송을 완료하셨군요👍';
			case 'user_experience_survey_bottom_sheet.text2': return '코코넛 월렛이 도움이 되었나요?';
			case 'user_experience_survey_bottom_sheet.text3': return '네, 좋아요!';
			case 'user_experience_survey_bottom_sheet.text4': return '그냥 그래요';
			case 'errors.storage_read_error': return '저장소에서 데이터를 불러오는데 실패했습니다.';
			case 'errors.storage_write_error': return '저장소에 데이터를 저장하는데 실패했습니다.';
			case 'errors.network_error': return '네트워크에 연결할 수 없어요. 연결 상태를 확인해 주세요.';
			case 'errors.node_connection_error': return '비트코인 노드와 연결하는데 실패했습니다.';
			case 'errors.fetch_wallet_error': return '지갑을 가져오는데 실패했습니다.';
			case 'errors.wallet_sync_failed_error': return '네트워크에서 지갑 정보 불러오기 실패';
			case 'errors.fetch_balance_error': return '잔액 조회를 실패했습니다.';
			case 'errors.fetch_transaction_list_error': return '트랜잭션 목록 조회를 실패했습니다.';
			case 'errors.fetch_transactions_error': return '거래 내역을 가져오는데 실패했습니다.';
			case 'errors.database_path_error': return 'DB 경로를 찾을 수 없습니다.';
			case 'errors.fee_estimation_error': return '수수료 계산을 실패했습니다.';
			case 'errors.realm_unknown': return '알 수 없는 오류가 발생했습니다.';
			case 'errors.realm_not_found': return '데이터를 찾을 수 없습니다.';
			case 'errors.realm_exception': return 'Realm 작업 중 오류가 발생했습니다.';
			case 'errors.node_unknown': return '노드 연결 중 알 수 없는 오류가 발생했습니다.';
			case 'errors.broadcast_error': return '트랜잭션 전송에 실패했습니다.';
			case 'errors.network_connect': return '네트워크 연결이 없습니다.';
			case 'errors.network_not_found': return '네트워크가 연결되어 있지 않아요!';
			case 'errors.insufficient_balance': return '잔액이 부족해요.';
			case 'errors.fee_selection_error.insufficient_balance': return '잔액이 부족하여 수수료를 낼 수 없어요';
			case 'errors.fee_selection_error.recommended_fee_unavailable': return '추천 수수료를 조회하지 못했어요.\n\'변경\' 버튼을 눌러 수수료를 직접 입력해 주세요.';
			case 'errors.fee_selection_error.insufficient_utxo': return 'UTXO 합계가 모자라요';
			case 'errors.address_error.invalid': return '올바른 주소가 아니에요.';
			case 'errors.address_error.not_for_testnet': return '테스트넷 주소가 아니에요.';
			case 'errors.address_error.not_for_mainnet': return '메인넷 주소가 아니에요.';
			case 'errors.address_error.not_for_regtest': return '레그테스트넷 주소가 아니에요.';
			case 'errors.address_error.duplicated': return '이미 입력한 주소예요';
			case 'errors.pin_check_error.trial_count': return ({required Object count}) => '${count}번 다시 시도할 수 있어요';
			case 'errors.pin_check_error.failed': return '더 이상 시도할 수 없어요\n앱을 종료해 주세요';
			case 'errors.pin_check_error.incorrect': return '비밀번호가 일치하지 않아요';
			case 'errors.pin_setting_error.already_in_use': return '이미 사용중인 비밀번호예요';
			case 'errors.pin_setting_error.process_failed': return '처리 중 문제가 발생했어요';
			case 'errors.pin_setting_error.save_failed': return '저장 중 문제가 발생했어요';
			case 'errors.pin_setting_error.incorrect': return '비밀번호가 일치하지 않아요';
			case 'errors.data_loading_failed': return '데이터를 불러오는 중 오류가 발생했습니다.';
			case 'errors.data_not_found': return '데이터가 없습니다.';
			case 'text_field.enter_fee_as_natural_number': return '수수료를 자연수로 입력해 주세요.';
			case 'text_field.enter_fee_directly': return '직접 입력하기';
			case 'text_field.search_mnemonic_word': return '영문으로 검색해 보세요';
			...
			case 'tooltip.wallet_add1': return '새로운 지갑을 추가하거나 이미 추가한 지갑의 정보를 업데이트할 수 있어요. ';
			case 'tooltip.wallet_add2': return '볼트';
			case 'tooltip.wallet_add3': return '에서 사용하시려는 지갑을 선택하고, ';
			case 'tooltip.wallet_add4': return '내보내기 ';
			case 'tooltip.wallet_add5': return '화면에 나타나는 QR 코드를 스캔해 주세요.';
			case 'tooltip.amount_to_be_sent': return ({required Object bitcoin}) => '받기 완료된 비트코인만 전송 가능해요.\n받는 중인 금액: ${bitcoin} BTC';
			case 'tooltip.scan_signed_psbt': return '볼트 앱에서 생성된 서명 트랜잭션이 보이시나요? 이제, QR 코드를 스캔해 주세요.';
			case 'tooltip.unsigned_tx_qr.in_vault': return '볼트에서';
			case 'tooltip.unsigned_tx_qr.select_wallet': return ({required Object name}) => '${name} 선택, ';
			case 'tooltip.unsigned_tx_qr.scan_qr_below': return '로 이동하여 아래 QR 코드를 스캔해 주세요.';
			case 'tooltip.address_receiving': return '비트코인을 받을 때 사용하는 주소예요. 영어로 Receiving 또는 External이라고 해요.';
			case 'tooltip.address_change': return '다른 사람에게 비트코인을 보내고 남은 비트코인을 거슬러 받는 주소예요. 영어로 Change라고 해요.';
			case 'tooltip.utxo': return 'UTXO란 Unspent Tx Output을 줄인 말로 아직 쓰이지 않은 잔액이란 뜻이에요. 비트코인에는 잔액 개념이 없어요. 지갑에 표시되는 잔액은 UTXO의 총합이라는 것을 알아두세요.';
			case 'tooltip.faucet': return '테스트용 비트코인으로 마음껏 테스트 해보세요';
			case 'tooltip.multisig_wallet': return ({required Object total, required Object count}) => '${total}개의 키 중 ${count}개로 서명해야 하는\n다중 서명 지갑이에요.';
			case 'tooltip.mfp': return '지갑의 고유 값이에요.\n마스터 핑거프린트(MFP)라고도 해요.';
			case 'tooltip.rbf': return '수수료를 올려, 기존 거래를 새로운 거래로 대체하는 기능이에요. (RBF, Replace-By-Fee)';
			case 'tooltip.cpfp': return '새로운 거래(Child)에 높은 수수료를 지정해 기존 거래(Parent)가 빨리 처리되도록 우선순위를 높이는 기능이에요. (CPFP, Child-Pays-For-Parent)';
			case 'toast.back_exit': return '뒤로 가기 버튼을 한 번 더 누르면 종료됩니다.';
			case 'toast.min_fee': return ({required Object minimum}) => '현재 최소 수수료는 ${minimum} sats/vb 입니다.';
			case 'toast.fetching_onchain_data': return '최신 데이터를 가져오는 중입니다. 잠시만 기다려주세요.';
			case 'toast.screen_capture': return '스크린 캡처가 감지되었습니다.';
			case 'toast.no_balance': return '잔액이 없습니다.';
			case 'toast.memo_update_failed': return '메모를 업데이트하지 못했어요.';
			case 'toast.tag_add_failed': return '태그를 추가하지 못했어요.';
			case 'toast.tag_update_failed': return '태그를 편집할 수 없어요.';
			case 'toast.tag_delete_failed': return '태그를 삭제할 수 없어요.';
			case 'toast.wallet_detail_refresh': return '화면을 아래로 당겨 최신 데이터를 가져와 주세요.';
			case 'alert.error_tx.not_parsed': return ({required Object error}) => '트랜잭션 파싱 실패: ${error}';
			case 'alert.error_tx.not_created': return ({required Object error}) => '트랜잭션 생성 실패 ${error}';
			case 'alert.error_send.broadcasting_failed': return ({required Object error}) => '[전송 실패]\n${error}';
			case 'alert.error_send.insufficient_balance': return '잔액이 부족해요';
			case 'alert.error_send.minimum_amount': return ({required Object bitcoin}) => '${bitcoin} BTC 부터 전송할 수 있어요';
			case 'alert.error_send.poor_network': return '네트워크 상태가 좋지 않아\n처음으로 돌아갑니다.';
			case 'alert.error_send.insufficient_fee': return '[전송 실패]\n수수료율을 높여서\n다시 시도해주세요.';
			case 'alert.signed_psbt.invalid_qr': return '잘못된 QR코드예요.\n다시 확인해 주세요.';
			case 'alert.signed_psbt.wrong_send_info': return '전송 정보가 달라요.\n처음부터 다시 시도해 주세요.';
			case 'alert.signed_psbt.need_more_sign': return ({required Object count}) => '${count}개 서명이 더 필요해요';
			case 'alert.signed_psbt.invalid_signature': return '잘못된 서명 정보에요. 다시 시도해 주세요.';
			case 'alert.scan_failed': return ({required Object error}) => '\'[스캔 실패] ${error}\'';
			case 'alert.scan_failed_description': return ({required Object error}) => 'QR코드 스캔에 실패했어요. 다시 시도해 주세요.\n${error}';
			case 'alert.tutorial.title': return '도움이 필요하신가요?';
			case 'alert.tutorial.description': return '튜토리얼 사이트로\n안내해 드릴게요';
			case 'alert.tutorial.btn_view': return '튜토리얼 보기';
			case 'alert.forgot_password.title': return '비밀번호를 잊으셨나요?';
			case 'alert.forgot_password.description': return '[다시 설정]을 눌러 비밀번호를 초기화할 수 있어요. 비밀번호를 바꾸면 동기화된 지갑 목록이 초기화 돼요.';
			case 'alert.forgot_password.btn_reset': return '다시 설정';
			case 'alert.wallet_add.update_failed': return '업데이트 실패';
			case 'alert.wallet_add.update_failed_description': return ({required Object name}) => '${name}에 업데이트할 정보가 없어요';
			case 'alert.wallet_add.duplicate_name': return '이름 중복';
			case 'alert.wallet_add.duplicate_name_description': return '같은 이름을 가진 지갑이 있습니다.\n이름을 변경한 후 동기화 해주세요.';
			case 'alert.wallet_add.add_failed': return '보기 전용 지갑 추가 실패';
			case 'alert.wallet_add.add_failed_description': return '잘못된 지갑 정보입니다.';
			case 'alert.wallet_delete.confirm_delete': return '지갑 삭제';
			case 'alert.wallet_delete.confirm_delete_description': return '지갑을 정말 삭제하시겠어요?';
			case 'alert.update.title': return '업데이트 알림';
			case 'alert.update.description': return '안정적인 서비스 이용을 위해\n최신 버전으로 업데이트 해주세요.';
			case 'alert.update.btn_update': return '업데이트 하기';
			case 'alert.update.btn_do_later': return '다음에 하기';
			case 'alert.error_occurs': return '오류 발생';
			case 'alert.contact_admin': return ({required Object error}) => '관리자에게 문의하세요. ${error}';
			case 'alert.tag_apply.title': return '태그 적용';
			case 'alert.tag_apply.description': return '기존 UTXO의 태그를 새 UTXO에도 적용하시겠어요?';
			case 'alert.tag_apply.btn_apply': return '적용하기';
			case 'alert.tx_detail.fetch_failed': return '트랜잭션 가져오기 실패';
			case 'alert.tx_detail.fetch_failed_description': return '잠시 후 다시 시도해 주세요';
			case 'alert.tag_delete.title': return '태그 삭제';
			case 'alert.tag_delete.description': return ({required Object name}) => '#${name}를 정말로 삭제하시겠어요?\n';
			case 'alert.tag_delete.description_utxo_tag': return ({required Object name, required Object count}) => '${name}를 정말로 삭제하시겠어요?\n${count}개 UTXO에 적용되어 있어요.';
			case 'alert.recipient_delete.description': return '입력하신 정보가 사라져요.\n그래도 지우시겠어요?';
