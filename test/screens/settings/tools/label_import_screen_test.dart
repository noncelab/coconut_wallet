...
void main() {
  ...
  testWidgets('shows and selects a very large memo file on the import screen', (tester) async {
    ...
    await pumpUntilFound(tester, find.text(t.label_import_file_picker_screen.option_selection.title));

    expect(find.text(t.label_import_file_picker_screen.option_selection.title), findsOneWidget);
    expect(find.text(fileName), findsOneWidget);
  });
}
