    ...
    group('normalizeDescriptor', () {
      ...
      test("NetworkType에 따른 주소가 맞는지 검증(Descriptor)", () {
        ...
        expectErrorMessage(
          ...
          t.wallet_add_scanner_screen.paste.unsupported_wallet_error_text,
        );
...
void expectErrorMessage(VoidCallback func, String errorText) {
  ...
  String getErrorMessageByError(e) {
    if (e.toString().contains("network type")) {
      ...
      return t.wallet_add_scanner_screen.paste.unsupported_wallet_error_text;
    } else {
      return t.wallet_add_scanner_screen.paste.format_error_text;
    }
  }
