...
const _legacyInheritanceMiniscript = "and_v(v:pk([70C4E9DE/86'/1'/0']$_childTaprootXpub/<0;1>/*),older(500000000))";
const _oneParentDescriptor = "tr([9B1441E4/86'/1'/0']$_parentTaprootXpub/<0;1>/*,{$_inheritanceMiniscript})#652j50l8";
const _legacyDescriptor =
    "tr([9B1441E4/86'/1'/0']$_parentTaprootXpub/<0;1>/*,{$_legacyInheritanceMiniscript})#w0hf4lu5";
  ...
  group('CoconutWalletAddQrScanDataHandler', () {
    ...
    test('legacy older Taproot JSON은 after로 변환한 뒤 완료한다', () {
      ...
      final data = jsonEncode({
        ...
        'colorIndex': 0,
        'iconIndex': 0,
        'descriptor': _legacyDescriptor,
        'keyPathSeedInfos': [_parentTaprootXpub],
        'scriptPathSeedInfos': [
          {
            'miniscript': _legacyInheritanceMiniscript,
            'extendedPublicKeys': [_childTaprootXpub],
          },
        ],
      });
